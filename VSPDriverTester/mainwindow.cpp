...
inline void MainWindow::initComboSerialPort(QComboBox* cbx, QComboBox* link)
{
...
inline void MainWindow::initComboBaudRate(QComboBox* cbx, QComboBox* link)
{
...
inline void MainWindow::initComboDataBits(QComboBox* cbx, QComboBox* link)
{
    const QIcon icon3(":/res/actions/16x16/debug-exec.png");
...
inline void MainWindow::initComboStopBits(QComboBox* cbx, QComboBox* link)
{
    const QIcon icon3(":/res/actions/16x16/debug-exec.png");
...
inline void MainWindow::initComboParity(QComboBox* cbx, QComboBox* link)
{
    const QIcon icon3(":/res/actions/16x16/debug-exec.png");
...
inline void MainWindow::initComboFlowCtrl(QComboBox* cbx, QComboBox* link)
{
    const QIcon icon3(":/res/actions/16x16/debug-exec.png");
...
inline void MainWindow::connectPort()
{
    if (!m_port->isOpen()) {
...
inline void MainWindow::disconnectPort()
{
...
void MainWindow::on_btnConnect_clicked()
{
    if (!m_port) {
        ...
        connect(m_port, &QSerialPort::errorOccurred, this, &MainWindow::onPortErrorOccured);
        connect(m_port, &QSerialPort::bytesWritten, this, &MainWindow::onPortBytesWritten);
        connect(m_port, &QSerialPort::aboutToClose, this, &MainWindow::onPortClosed);
        connect(m_port, &QSerialPort::readyRead, this, &MainWindow::onPortReadyRead);
...
void MainWindow::on_edOutputLine_textEdited(const QString&)
{
}

void MainWindow::on_btnSendLine_clicked()
{
    if (!m_port)
        return;
...
void MainWindow::on_btnLooper_clicked()
{
    if (!m_isLooping) {
...
void MainWindow::onPortErrorOccured(QSerialPort::SerialPortError error)
{
...
void MainWindow::onPortBytesWritten(qint64 bytes)
{
    m_outTotal += bytes;
